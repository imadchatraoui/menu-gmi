...
function MenuItem({ link, text, image, speed, textColor, marqueeBgColor, marqueeTextColor, borderColor, onItemClick, page }) {
  ...
  return (
    <div className="menu__item" ref={itemRef} style={{ borderColor }}>
      <a
        ...
        href={link}
        onClick={e => { e.preventDefault(); onItemClick && onItemClick(page); }}
